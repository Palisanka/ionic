...
const index = require('./index-28fdd6df.js');
...
class Menu {
    ...
    async componentWillLoad() {
        ...
        this.gesture = (await new Promise(function (resolve) { resolve(require('./index-28fdd6df.js')); })).createGesture({
            el: document,
...
class MenuButton {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { onClick: this.onClick, "aria-disabled": disabled ? 'true' : null, "aria-hidden": hidden ? 'true' : null, class: Object.assign({ [mode]: true }, __chunk_5.createColorClasses(color), { 'button': true, 'menu-button-hidden': hidden, 'menu-button-disabled': disabled, 'ion-activatable': true, 'ion-focusable': true }) }, __chunk_1.h("button", Object.assign({}, attrs, { disabled: this.disabled, class: "button-native" }), __chunk_1.h("slot", null, __chunk_1.h("ion-icon", { icon: menuIcon, mode: mode, lazy: false })), mode === 'md' && __chunk_1.h("ion-ripple-effect", { type: "unbounded" }))));
    }
...
class MenuController {
    ...
    async _createAnimation(type, menuCmp) {
        ...
        const animation = await new Promise(function (resolve) { resolve(require('./index-68424d7d.js')); })
